...
func TestValue(t *testing.T) {
	...
	requireT.Equal(
		[]byte{
			0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0xff, 0x0, 0x0, 0x0, 0x1, 0x2, 0x3, 0x4, 0x5,
			0x6, 0x7, 0x8, 0x9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		},
		photon1.B,
	)
...
func TestSlice(t *testing.T) {
	...
	requireT.Equal(
		[]byte{
			0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0xff, 0x0, 0x0, 0x0, 0x1, 0x2, 0x3, 0x4, 0x5,
			0x6, 0x7, 0x8, 0x9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x0, 0x0, 0x64, 0x0, 0x0, 0x0, 0x9, 0x8, 0x7, 0x6, 0x5, 0x4, 0x3, 0x2, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x0, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x32, 0x0, 0x0, 0x0, 0xa, 0xb, 0xc, 0xd,
			0xe, 0xf, 0x10, 0x11, 0x12, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		},
		photon1.B,
	)
...
func TestFromPointer(t *testing.T) {
	...
	requireT.Equal(msg, *FromPointer[msg1](unsafe.Pointer(&NewFromValue(&msg).B[0])))
}
...
func TestSliceFromPointer(t *testing.T) {
	...
	requireT.Equal(msgs, SliceFromPointer[msg1](unsafe.Pointer(&NewFromSlice(msgs).B[0]), len(msgs)))
}
